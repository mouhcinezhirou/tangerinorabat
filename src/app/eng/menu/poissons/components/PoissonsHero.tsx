  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          From fresh fish caught in the Mediterranean to delicious meats carefully prepared, discover a selection of quality products where each piece is enhanced by our expertise.
        </motion.p>
