  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Authentic flavors simmered over low heat in our local casseroles.
          Discover our creations inspired by Mediterranean traditions, where every bite tells a story.
        </motion.p>
