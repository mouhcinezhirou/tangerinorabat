  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
Discover the exquisite flavors of the Mediterranean with our selection of high-quality fresh seafood and hand-picked oysters, prepared with culinary mastery.        </motion.p>
