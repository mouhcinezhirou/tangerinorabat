  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
Discover our exceptional selection of prestigious champagnes and carefully selected wines, combining winemaking tradition and culinary excellence to accompany your special moments.
        </motion.p>
