      ...
      <motion.div variants={containerVariants}>
        {hasBottle && (
          <div className={`grid ${hasHalf ? 'grid-cols-[2fr_0.5fr_0.5fr_0.5fr]' : hasGlass ? 'grid-cols-[2fr_0.5fr_0.5fr]' : 'grid-cols-[2fr_0.5fr]'} text-amber-100/80 font-light text-sm mb-2`}>
            ...
            {hasGlass && <div className="text-center">Glass</div>}
          </div>
        )}
              ...
              {hasBottle ? (
                ...
                <div className="flex justify-between min-w-[120px]">
                  {item.glass !== undefined && item.glass !== '-' && (
                    <span className="text-amber-200/80 text-sm mr-4">Glass: {item.glass}</span>
                  )}
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="space-y-8">
              <h4 className="text-center font-SweetSansProBold text-2xl font-serif tracking-wider text-amber-100">WHITE</h4>
            ...
            <div className="space-y-8">
              <h4 className="text-center font-SweetSansProBold text-2xl font-serif tracking-wider text-amber-100">RED</h4>
