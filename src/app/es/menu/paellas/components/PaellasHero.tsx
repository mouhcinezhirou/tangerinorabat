  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Desde paellas valencianas hasta pasta fresca italiana, explora nuestras creaciones donde el arroz y la pasta 
          se adornan con los sabores soleados del Mediterráneo para un viaje culinario inolvidable.
        </motion.p>
