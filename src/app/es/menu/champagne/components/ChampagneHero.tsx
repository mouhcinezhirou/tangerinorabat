  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
Descubra nuestra excepcional selección de prestigiosos champagnes y vinos cuidadosamente seleccionados, que combinan la tradición vitivinícola y la excelencia gustativa para acompañar sus momentos especiales.
        </motion.p>
