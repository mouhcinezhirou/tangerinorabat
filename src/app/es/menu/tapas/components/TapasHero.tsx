...
export default function TapasEntreesHero() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Descubra nuestra refinada selección de tapas españolas y entrantes franceses, 
          Elaborado con ingredientes frescos de temporada y un toque mediterráneo único.
        </motion.p>
