  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/desserts.jpg" // Replace with your actual dessert image path
          alt="Sélection de desserts méditerranéens"
          layout="fill"
          objectFit="cover"
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
Un dulce viaje a través de los sabores mediterráneos, donde la repostería tradicional y las creaciones contemporáneas se combinan para dar un final dulce a tu comida.
        </motion.p>
