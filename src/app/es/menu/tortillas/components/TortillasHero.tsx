...
export default function OeufsFrituresHero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/tortillas.jpg"
          alt="Sélection d'œufs et fritures méditerranéennes"
          layout="fill"
          objectFit="cover"
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Desde el sutil arte de la tortilla española hasta las crujientes patatas fritas del Mediterráneo, saborea nuestras creaciones donde los huevos y las frituras vienen en deliciosas variaciones.
        </motion.p>
        ...
        >
          <div className="flex flex-col items-center">
            <span className="text-amber-200/60 text-sm tracking-widest mb-2 hover:text-amber-200 transition-colors">EXPLORAR</span>
