  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Desde pescado fresco capturado en el Mediterráneo hasta sabrosas carnes cuidadosamente preparadas,
          Descubra una selección de productos de calidad donde cada pieza se ve realzada por nuestro saber hacer.
        </motion.p>
