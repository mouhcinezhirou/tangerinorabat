...
export default function CassolettesHero() {
  ...
  return (
    <section 
      ref={heroRef} 
      className="relative h-screen min-h-[600px] overflow-hidden bg-[#1e2428] text-amber-50"
    >
      {/* Background image with overlay */}
      <div className="absolute inset-0">
        <Image
          src="/cassolettes.jpg"
          alt="Sélection de cassolettes mijotées"
          layout="fill"
          objectFit="cover"
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
Sabores auténticos cocinados a fuego lento en nuestras cazuelas locales. 
Descubre nuestras creaciones inspiradas en las tradiciones mediterráneas, donde cada bocado cuenta una historia.
        </motion.p>
