...
const menuItems = [
  ...
  { id: 'huitres', label: 'Ostras y Mariscos', link: '/es/menu/seafood' },
  { id: 'tapas', label: 'Tapas y Entrantes', link: '/es/menu/tapas' },
  { id: 'tortillas', label: 'Tortillas y Frituras', link: '/es/menu/tortillas' },
  { id: 'cassolettes', label: 'Cazuelitas', link: '/es/menu/cassolettes' },
