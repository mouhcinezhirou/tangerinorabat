  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Un voyage sucré à travers les saveurs méditerranéennes, où pâtisseries traditionnelles
          et créations contemporaines se marient pour clore votre repas en douceur.
        </motion.p>
