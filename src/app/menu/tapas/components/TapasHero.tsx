  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Découvrez notre sélection raffinée de tapas espagnoles et d'entrées françaises, 
          préparées avec des ingrédients frais de saison et une touche méditerranéenne unique.
        </motion.p>
