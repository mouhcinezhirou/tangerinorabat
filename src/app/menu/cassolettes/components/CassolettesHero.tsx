  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          Des saveurs authentiques mijotées à feu doux dans nos cassolettes de terroir. 
          Découvrez nos créations inspirées des traditions méditerranéennes, où chaque bouchée raconte une histoire.
        </motion.p>
