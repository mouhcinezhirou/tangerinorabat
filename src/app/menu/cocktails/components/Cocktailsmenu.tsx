    ...
    const menuSections: CocktailSection[] = [
      ...
      },
      {
        ...
        items: [
          {
            name: 'AGUA MINERAL',
            description: 'Eau Minérale - Sidi Ali, Evian, Evian Pétillante, Oulmès',
            price: 50,
            detailedDescription: 'Une sélection soignée d\'eaux premium provenant de sources naturelles et montagneuses. Des montagnes de l\'Atlas marocain jusqu\'aux Alpes françaises, chaque bouteille apporte un rafraîchissement minéral pur à votre table.'
          },
          {
            name: 'ZUMO FRESCO',
          ...
          {
            name: 'CAFÉ',
            description: 'Expresso, Americano, Cappuccino',
            price: 50,
          ...
          {
            name: 'TÉ',
            description: 'Menthe fraîche, Earl Grey, Darjeeling',
            price: 50,
            detailedDescription: 'Une sélection mondiale de thés fins, du classique thé à la menthe marocain aux rares oolongs chinois. Chaque variété est infusée à la perfection et servie avec des accompagnements traditionnels.'
          }
        ]
      }
    ];
