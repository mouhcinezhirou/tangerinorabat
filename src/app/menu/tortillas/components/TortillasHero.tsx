  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          De l'art subtil de la tortilla espagnole aux fritures croustillantes de la Méditerranée, 
          savourez nos créations où l'œuf et les fritures se déclinent en délicieuses variations.
        </motion.p>
